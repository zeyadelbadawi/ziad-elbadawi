...
`}for(q++;q<J&&$.charCodeAt(q)===_;)q++;G=q;continue}q++}return G<J&&(V+=$.slice(G,J)),i0(V,0,V.length,Q,X)}function rZ($,Z,J){if($.charCodeAt(Z)!==Z0)return null;let Q=S9($,Z,J,96),X=Z+Q;for(;X<J;){let Y=$.indexOf("`",X);if(Y<0||Y>=J)return null;let V=S9($,Y,J,96);if(V===Q){let G=$.slice(Z+Q,Y);return G=G.replace(/\n/g," "),G.length>0&&G[0]===" "&&G[G.length-1]===" "&&G.trim().length>0&&(G=G.slice(1,-1)),{node:{type:A.codeInline,text:G},end:Y+V}}X=Y+V}return null}function E$($,Z,J){if($.charCodeAt(Z)!==Z0)return Z;let Q=S9($,Z,J,96),X=Z+Q;for(;X<J;){let Y=$.indexOf("`",X);if(Y<0||Y>=J)return Z;let V=S9($,Y,J,96);if(V===Q)return Y+V;X=Y+V}return Z}function n6($,Z,J){if($.charCodeAt(Z)!==t)return Z;if(Z+1<J&&$.charCodeAt(Z+1)===v0){let U=Z+2;for(;U<J&&$.charCodeAt(U)!==c;)U++;return U<J?U+1:Z}if(Z+3<J&&$.charCodeAt(Z+1)===f0&&$.charCodeAt(Z+2)===d&&$.charCodeAt(Z+3)===d){let U=$.indexOf("-->",Z+4);return U>=0?U+3:Z}let Q=Z+1,X=Q;for(;Q<J;){let U=$.charCodeAt(Q);if(U>=p&&U<=l||U>=Q0&&U<=q0||U>=i&&U<=a||U===d)Q++;else break}if(Q===X)return Z;let Y=$.slice(X,Q).toLowerCase(),V=!1;for(;Q<J;){let U=$.charCodeAt(Q);if(U===c){Q++;break}if(U===v0&&Q+1<J&&$.charCodeAt(Q+1)===c){Q+=2,V=!0;break}if(U===G9||U===g9){var G=U;for(Q++;Q<J&&$.charCodeAt(Q)!==G;)Q++;Q<J&&Q++;continue}if(U===T)return Z;Q++}if(V||a9(Y))return Q;let q=1;for(;Q<J&&q>0;)if($.charCodeAt(Q)===t)if(Q+1<J&&$.charCodeAt(Q+1)===v0){let U=Q+2,W=U;for(;W<J&&($.charCodeAt(W)>=p&&$.charCodeAt(W)<=l||$.charCodeAt(W)>=Q0&&$.charCodeAt(W)<=q0);)W++;if($.slice(U,W).toLowerCase()===Y){for(;W<J&&$.charCodeAt(W)!==c;)W++;if(W<J&&W++,q--,q===0)return W}Q=W}else{let U=Q+1,W=U;for(;W<J&&($.charCodeAt(W)>=p&&$.charCodeAt(W)<=l||$.charCodeAt(W)>=Q0&&$.charCodeAt(W)<=q0);)W++;$.slice(U,W).toLowerCase()===Y&&q++,Q++}else Q++;return Q}function iZ($,Z,J,Q,X){if($.charCodeAt(Z)!==b0||Z+1>=J||$.charCodeAt(Z+1)!==b0)return null;let Y=Z+2;for(;Y+1<J;){let V=$.charCodeAt(Y);if(V===Z0){let G=E$($,Y,J);if(G>Y){Y=G;continue}}if(V===b0&&$.charCodeAt(Y+1)===b0){let G=$.slice(Z+2,Y),q=i0(G,0,G.length,Q,X);return{node:{type:A.textFormatted,tag:"del",children:q},end:Y+2}}V===y0&&Y+1<J&&Y++,Y++}return null}function aZ($,Z,J,Q,X){if($.charCodeAt(Z)!==l0||Z+1>=J||$.charCodeAt(Z+1)!==l0)return null;let Y=Z+2;for(;Y+1<J;){let V=$.charCodeAt(Y);if(V===Z0){let G=E$($,Y,J);if(G>Y){Y=G;continue}}if(V===l0&&$.charCodeAt(Y+1)===l0&&Y>Z+2){let G=$.slice(Z+2,Y),q=i0(G,0,G.length,Q,X);return{node:{type:A.textFormatted,tag:"mark",children:q},end:Y+2}}V===y0&&Y+1<J&&Y++,Y++}return null}function g6($,Z,J){return $<Z$?!!(s$($)&i9):I6.test(Z[J])}function h6($,Z,J){return $<Z$?!!(s$($)&R9):P6.test(Z[J])}function nZ($,Z,J){var Q=$.charCodeAt(Z);if(Q!==j0&&Q!==z0)return null;var X=S9($,Z,J,Q);if(X===0)return null;var Y=Z>0?$.charCodeAt(Z-1):32,V=Z+X<J?$.charCodeAt(Z+X):32,G=h6(Y,$,Z-1),q=h6(V,$,Z+X),U=Z>0?g6(Y,$,Z-1):!1,W=Z+X<J?g6(V,$,Z+X):!1,F=!q&&(!W||G||U),O=!G&&(!U||q||W),K,B;return Q===j0?(K=F,B=O):(K=F&&(!O||U),B=O&&(!F||W)),{len:X,canOpen:K,canClose:B}}function sZ($,Z,J,Q){if(Z.length!==0){for(var X=[],Y=0;Y<12;Y++)X[Y]=-1;for(var V=0;V<Z.length;){var G=Z[V];if(!G.active||!G.canClose){V++;continue}for(var q=G.ch===j0?0:1,U=q*6+G.len%3*2+(G.canOpen?1:0),W=X[U]!==void 0?X[U]:-1,F=-1,O=V-1;O>W;O--){var K=Z[O];if(!(!K.active||K.ch!==G.ch||!K.canOpen)&&!((G.canOpen||K.canClose)&&(K.len+G.len)%3===0&&K.len%3!==0)){F=O;break}}if(F<0){X[U]=V-1,!G.canOpen&&(G.active=!1),V++;continue}var B=Z[F],z=B.len>=2&&G.len>=2,H=z?2:1;B.len-=H,G.len-=H;var D=$[B.idx],M=$[G.idx];D.text=D.text.slice(0,D.text.length-H),M.text=M.text.slice(H);var v=B.idx+1,f=G.idx,I=$.slice(v,f),j={type:A.textFormatted,tag:z?"strong":"em",children:I};$.splice(v,f-v,j);for(var S=f-v-1,k=0;k<Z.length;k++)Z[k].idx>B.idx&&(Z[k].idx-=S);for(var R=F+1;R<V;R++)Z[R].active=!1;if(B.len===0&&(B.active=!1,D.text==="")){$.splice(B.idx,1);for(var P=0;P<Z.length;P++)Z[P].idx>B.idx?Z[P].idx--:Z[P].idx===B.idx&&(Z[P].idx=-1)}if(G.len===0){G.active=!1;var E=G.idx;if(M.text===""){$.splice(E,1);for(var b=0;b<Z.length;b++)Z[b].idx>E?Z[b].idx--:Z[b].idx===E&&(Z[b].idx=-1)}}else continue;V++}for(var g=0,x=0;x<$.length;x++){var h=$[x];if(h.type===A.text){var y=h;if(y.text==="")continue;if(g>0&&$[g-1].type===A.text){$[g-1].text+=y.text;continue}}$[g++]=h}$.length=g}}function x6($,Z,J,Q,X){let Y=$.charCodeAt(Z)===f0,V=Y?Z+1:Z;if($.charCodeAt(V)!==O0)return null;var G=$.indexOf("]",V+1);if(G<0||G>=J)return null;for(var q=V+1,U=-1,W=1;q<J&&W>0;){var F=$.charCodeAt(q);if(F===y0&&q+1<J){q+=2;continue}if(F===Z0){var O=E$($,q,J);if(O>q){q=O;continue}}if(F===t){var K=s6($,q,J);if(K){q=K.end;continue}var B=n6($,q,J);if(B>q){q=B;continue}}F===O0?W++:F===Z9&&W--,q++}if(W!==0)return null;var z=q-1,H=$.slice(V+1,z),D=q<J?$.charCodeAt(q):0,M=!1;if(D===H9){var v=!0;for(q++;q<J&&($.charCodeAt(q)===_||$.charCodeAt(q)===T);)q++;var f="",I=q;if(q<J&&$.charCodeAt(q)===t){for(q++,I=q;I<J&&$.charCodeAt(I)!==c;){if($.charCodeAt(I)===y0&&I+1<J){I+=2;continue}if($.charCodeAt(I)===T){v=!1;break}I++}v&&(I>=J||$.charCodeAt(I)!==c)&&(v=!1),v&&(f=$.slice(q,I),I++)}else if(v)if(Q.f!==void 0&&q>=Q.f)v=!1;else{for(var j=0,S=!1;I<J;){var k=$.charCodeAt(I);if(k===y0&&I+1<J){I+=2;continue}if(k===H9)j++;else if(k===D9){if(S=!0,j===0)break;j--}else if(k===_||k===T)break;I++}I>=J&&!S&&(Q.f===void 0||q<Q.f)&&(Q.f=q),f=$.slice(q,I)}if(v){for(q=I;q<J&&($.charCodeAt(q)===_||$.charCodeAt(q)===T);)q++;var R;if(q<J){var P=$.charCodeAt(q);if(P===G9||P===g9||P===H9){var E=P===H9?41:P;q++;for(var b=q;q<J&&$.charCodeAt(q)!==E;)$.charCodeAt(q)===y0&&q+1<J&&q++,q++;q>=J?v=!1:(R=$.slice(b,q),q++)}}if(v){for(;q<J&&($.charCodeAt(q)===_||$.charCodeAt(q)===T);)q++;(q>=J||$.charCodeAt(q)!==D9)&&(v=!1)}}if(v){q++,f=X$(f),R!==void 0&&(R=x9(X$(R)));var g=X?.sanitizer||J$,x=g(f,Y?"img":"a",Y?"src":"href"),h=x===null?null:f;if(Y){var y=i0(H,0,H.length,Q,X),X0=S$(y);return{node:{type:A.image,target:h,alt:X0,title:R},end:q}}else{var o=Q.inAnchor;Q.inAnchor=!0;var C=o?[{type:A.text,text:H}]:i0(H,0,H.length,Q,X);return Q.inAnchor=o,!Q.inAnchor&&n$(C)?null:{node:{type:A.link,target:h,title:R,children:C},end:q}}}else q=z+1,M=!0}var F0="",$0=q;if(!M&&D===O0){var H0=q+1;$0=H0;for(var h0=!1;$0<J&&$.charCodeAt($0)!==Z9;){if($.charCodeAt($0)===y0&&$0+1<J){$0+=2;continue}if($.charCodeAt($0)===O0){h0=!0;break}$0++}if(h0||$0>=J)return null;var D0=$.slice(H0,$0);if(D0.trim())F0=w$(D0);else{if(k6(H))return null;F0=w$(H)}$0=$0+1}else{if(k6(H))return null;F0=w$(H)}var u=Q.refs[F0];if(!u)return null;if(Y)return{node:{type:A.image,target:u.target,alt:S$(i0(H,0,H.length,Q,X)),title:u.title},end:$0};var r=Q.inAnchor;Q.inAnchor=!0;var C=r?[{type:A.text,text:H}]:i0(H,0,H.length,Q,X);return Q.inAnchor=r,!Q.inAnchor&&n$(C)?null:{node:{type:A.link,target:u.target,title:u.title,children:C},end:$0}}function s6($,Z,J){if($.charCodeAt(Z)!==t)return null;for(var Q=Z+1;Q<J;){var X=$.charCodeAt(Q);if(X===c)break;if(X===_||X===T||X===P9||X===t)return null;Q++}if(Q>=J||$.charCodeAt(Q)!==c)return null;var Y=$.slice(Z+1,Q),V=Y.match(/^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^\x00-\x20]*)$/);return V?{node:{type:A.link,target:Y,title:void 0,children:[{type:A.text,text:Y}]},end:Q+1}:Y.indexOf("@")!==-1&&/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/.test(Y)?{node:{type:A.link,target:"mailto:"+Y,title:void 0,children:[{type:A.text,text:Y}]},end:Q+1}:null}function tZ($,Z,J,Q){if($.charCodeAt(Z)!==O0||Z+1>=J||$.charCodeAt(Z+1)!==O9)return null;let X=Z+2;for(;X<J&&$.charCodeAt(X)!==Z9&&$.charCodeAt(X)!==T;)X++;if(X>=J||$.charCodeAt(X)!==Z9)return null;let Y=$.slice(Z+2,X);return Y?{node:{type:A.footnoteReference,target:"#"+Q9(Y),text:Y},end:X+1}:null}function eZ($,Z,J,Q){if(Q.disableBareUrls)return null;var X="",Y=!1,V=$.charCodeAt(Z);if(V===l9||V===72?Z+8<=J&&$.charCodeAt(Z+1)===o9&&$.charCodeAt(Z+2)===o9&&$.charCodeAt(Z+3)===I$&&($.charCodeAt(Z+4)===d$&&$.charCodeAt(Z+5)===g0&&$.charCodeAt(Z+6)===v0&&$.charCodeAt(Z+7)===v0?X="https://":$.charCodeAt(Z+4)===g0&&$.charCodeAt(Z+5)===v0&&$.charCodeAt(Z+6)===v0&&(X="http://")):V===N9||V===70?Z+6<=J&&$.charCodeAt(Z+1)===o9&&$.charCodeAt(Z+2)===I$&&$.charCodeAt(Z+3)===g0&&$.charCodeAt(Z+4)===v0&&$.charCodeAt(Z+5)===v0&&(X="ftp://"):(V===_9||V===87)&&Z+4<=J&&$.charCodeAt(Z+1)===_9&&$.charCodeAt(Z+2)===_9&&$.charCodeAt(Z+3)===J9&&(X="www.",Y=!0),!X)return null;let G=Z+X.length;for(;G<J;){let j=$.charCodeAt(G);if(j===_||j===T||j===w||j===P9||j===t||j===c)break;G++}for(var q=0,U=0,W=Z;W<G;W++){var F=$.charCodeAt(W);F===H9?q++:F===D9&&U++}let O=G;for(;O>Z+X.length;){let j=$.charCodeAt(O-1);if(j===J9||j===O6||j===g0||j===f0||j===e9||j===D9||j===j0||j===z0||j===b0){if(j===D9){if(q>=U)break;U--}O--}else if(j===c$){for(var K=O-2;K>Z&&($.charCodeAt(K)>=p&&$.charCodeAt(K)<=l||$.charCodeAt(K)>=Q0&&$.charCodeAt(K)<=q0||$.charCodeAt(K)>=i&&$.charCodeAt(K)<=a);)K--;K>=Z&&$.charCodeAt(K)===t9?O=K:O--}else break}if(O<=Z+X.length)return null;var B=Z+(Y?4:X.length),z=$.indexOf("/",B);if((z<0||z>O)&&(z=O),Y&&$.indexOf(".",B)===-1)return null;for(var H=-1,D=-1,M=z-1;M>=B;M--)if($.charCodeAt(M)===J9)if(H<0)H=M;else{D=M;break}for(var v=D>=0?D+1:B,M=v;M<z;M++)if($.charCodeAt(M)===z0)return null;var f=$.slice(Z,O),I=Y?"http://"+f:f;return{node:{type:A.link,target:I,title:void 0,children:[{type:A.text,text:f}]},end:O}}function $J($,Z,J,Q){if(Q.disableBareUrls)return null;for(var X=Z,Y=X;X<J;){var V=$.charCodeAt(X);if(V>=p&&V<=l||V>=Q0&&V<=q0||V>=i&&V<=a||V===J9||V===f0||V===v9||V===36||V===K$||V===t9||V===g9||V===j0||V===b9||V===v0||V===l0||V===e9||V===O9||V===z0||V===Z0||V===h9||V===L0||V===P$||V===b0||V===d)X++;else break}if(X===Y||X>=J||$.charCodeAt(X)!==W$)return null;X++;for(var G=X,q=-1,U=X;X<J;){var V=$.charCodeAt(X);if(V>=p&&V<=l||V>=Q0&&V<=q0||V>=i&&V<=a)X++;else if((V===d||V===z0)&&X>G)X++;else if(V===J9){if(X===G)break;var W=$.charCodeAt(X-1);if(W===d||W===z0||X-U>63)break;if(X+1<J){var F=$.charCodeAt(X+1);if(F>=p&&F<=l||F>=Q0&&F<=q0||F>=i&&F<=a)q=X,U=X+1,X++;else break}else break}else break}if(X-U>63||q<0)return null;var O=$.charCodeAt(X-1);if(!(O>=p&&O<=l||O>=Q0&&O<=q0||O>=i&&O<=a)||X<=q+1)return null;for(var K=-1,B=q-1;B>=G;B--)if($.charCodeAt(B)===J9){K=B;break}for(var z=K>=0?K+1:G,B=z;B<X;B++)if($.charCodeAt(B)===z0)return null;var H=$.slice(Z,X);return{node:{type:A.link,target:"mailto:"+H,title:void 0,children:[{type:A.text,text:H}]},end:X}}function n$($){for(var Z=0;Z<$.length;Z++)if($[Z].type===A.link||"children"in $[Z]&&Array.isArray($[Z].children)&&n$($[Z].children))return!0;return!1}function S$($){for(var Z="",J=0;J<$.length;J++){var Q=$[J];Q.type===A.text?Z+=Q.text:Q.type===A.breakLine?Z+=" ":Q.type===A.codeInline?Z+=Q.text:"children"in Q&&Array.isArray(Q.children)?Z+=S$(Q.children):Q.type===A.image?Z+=Q.alt||"":Q.type===A.link&&(Z+=S$(Q.children))}return Z}function n9($){let Z=$.includes("&")?x9($):$;return{type:A.text,text:Z}}function ZJ($,Z,J,Q,X){if($.charCodeAt(Z)!==t)return null;var Y=Z+1;if(Y>=J)return null;var V=$.charCodeAt(Y);if(V===f0&&Y+1<J&&$.charCodeAt(Y+1)===d&&Y+2<J&&$.charCodeAt(Y+2)===d){var G=Y+3;if(G<J&&$.charCodeAt(G)===c)return{node:{type:A.htmlComment,text:"",g:!0},end:G+1};if(G+1<J&&$.charCodeAt(G)===d&&$.charCodeAt(G+1)===c)return{node:{type:A.htmlComment,text:"-",g:!0},end:G+2};var q=$.indexOf("-->",G);return q!==-1&&q<=J-3?{node:{type:A.htmlComment,text:$.slice(Z+4,q),g:!1},end:q+3}:null}if(V===e9){var U=$.indexOf("?>",Y+1);return U!==-1&&U<J?{node:{type:A.htmlSelfClosing,tag:"?",attrs:{},a:$.slice(Z,U+2),b:!1},end:U+2}:null}if(V===f0&&Y+1<J){var W=$.charCodeAt(Y+1);if(W===O0&&$.slice(Y+1,Y+8)==="[CDATA["){var F=$.indexOf("]]>",Y+8);return F!==-1&&F<J?{node:{type:A.htmlSelfClosing,tag:"![CDATA[",attrs:{},a:$.slice(Z,F+3),b:!1},end:F+3}:null}if(W>=p&&W<=l){var O=$.indexOf(">",Y+2);return O!==-1&&O<J?{node:{type:A.htmlSelfClosing,tag:"!"+$.slice(Y+1,O),attrs:{},a:$.slice(Z,O+1),b:!1},end:O+1}:null}}if(V===v0){var K=Y+1;if(K>=J)return null;var B=$.charCodeAt(K);if(!(B>=p&&B<=l||B>=Q0&&B<=q0))return null;for(K++;K<J;){var z=$.charCodeAt(K);if(z>=p&&z<=l||z>=Q0&&z<=q0||z>=i&&z<=a||z===d)K++;else break}for(;K<J&&($.charCodeAt(K)===_||$.charCodeAt(K)===w||$.charCodeAt(K)===T);)K++;if(K<J&&$.charCodeAt(K)===c){var H=$.slice(Y+1,K).trim();return{node:{type:A.htmlSelfClosing,tag:H,attrs:{},a:$.slice(Z,K+1),b:!0},end:K+1}}return null}if(!(V>=p&&V<=l||V>=Q0&&V<=q0))return null;var D=L9($,Z);if(!D)return null;var M=D.tag,v=M.toLowerCase(),f=D.selfClosing;if(f||a9(M))return{node:{type:A.htmlSelfClosing,tag:M,attrs:y9(D.attrs,M,X),a:$.slice(Z,D.end),b:!1},end:D.end};var I=D$.has(v),j=a$($.slice(0,J),D.end,M);if(j===-1)return{node:{type:A.htmlSelfClosing,tag:M,attrs:y9(D.attrs,M,X),a:$.slice(Z,D.end),b:!1},end:D.end};var S=uZ($,"</"+v,j),k=$.slice(D.end,S),R=[];if(I)k.trim()&&(R=[{type:A.text,text:k}]);else{var P=k.trim();if(P){var{inAnchor:E,inline:b}=Q;v==="a"&&(Q.inAnchor=!0);var g=P.indexOf(`

`)!==-1||/^#{1,6}\s/.test(P);g?(Q.inline=!1,R=k9(P,Q,X)):R=i0(P,0,P.length,Q,X),Q.inAnchor=E,Q.inline=b}}return{node:{type:A.htmlBlock,tag:M,attrs:y9(D.attrs,M,X),e:D.rawAttrs,children:R,a:void 0,text:k,c:!1,b:!1},end:j}}var JJ=200,Q$=0;function i0($,Z,J,Q,X){if(Q$++,Q$>JJ)return Q$--,[{type:A.text,text:$.slice(Z,J)}];var Y=Q.f;Q.f=void 0;let V=Q;if(X.optimizeForStreaming){let E0=function(L,N0){for(var V0=1,T0=N0+1;T0<L.length;T0++){var d0=L.charCodeAt(T0);if(d0===O0)V0++;else if(d0===Z9&&(V0--,V0===0))return T0}return-1},N=$.slice(Z,J),s=N;for(var G=0,q=0,U=0,W=0,F=0,O=-1,K=-1,B=-1,z=-1,H=-1,D=0;D<N.length;D++){var M=N.charCodeAt(D);M===j0?D+1<N.length&&N.charCodeAt(D+1)===j0?(G++,O=D,D++):(q++,K=D):M===z0?D+1<N.length&&N.charCodeAt(D+1)===z0?(U++,B=D,D++):(W++,z=D):M===b0&&D+1<N.length&&N.charCodeAt(D+1)===b0&&(F++,H=D,D++)}var v=[];F%2===1&&H>=0&&v.push([H,2]),U%2===1&&B>=0&&v.push([B,2]),W%2===1&&z>=0&&v.push([z,1]),G%2===1&&O>=0&&v.push([O,2]),q%2===1&&K>=0&&v.push([K,1]),v.sort(function(L,N0){return N0[0]-L[0]});for(var f=0;f<v.length;f++){var I=v[f][0],j=v[f][1];N=N.slice(0,I)+N.slice(I+j)}let B0=0,p0=-1;for(let L=0;L<N.length;L++)N.charCodeAt(L)===Z0&&(B0++,p0=L);if(B0%2===1&&p0!==-1){let L=!1,N0=-1,V0=0;for(;V0<N.length;)N.charCodeAt(V0)===Z0&&(L?(L=!1,N0=-1):(N0=V0,L=!0)),V0++;L&&N0!==-1&&(N=N.slice(0,N0))}for(var S=!0;S;){S=!1;for(var k=-1,R=-1,P=-1,E=!1,b=0;b<N.length;b++){var g=N.charCodeAt(b);if(g===O0&&(b===0||N.charCodeAt(b-1)!==y0)){var x=b>0&&N.charCodeAt(b-1)===f0,h=x?b-1:b,y=E0(N,b);if(y===-1)k=h,E=x,R=b+1,P=N.length;else{var X0=y+1;if(X0>=N.length)k=h,E=x,R=b+1,P=y;else if(N.charCodeAt(X0)===H9){var o=N.indexOf(")",X0+1);o===-1?(k=h,E=x,R=b+1,P=y,b=N.length):b=o}else if(N.charCodeAt(X0)===O0){var C=N.indexOf("]",X0+1);C===-1?(k=h,E=x,R=b+1,P=y,b=N.length):b=C}else b=y}}}if(k>=0){var F0=E?"":N.slice(R,P);N=N.slice(0,k)+F0,S=!0}}let A0=N.match(/<([A-Z][A-Za-z0-9]*)(?:\s[^>]*)?>([^<]*)$/);if(A0&&A0.index!==void 0){var $0=A0[0].length-A0[2].length,H0=$0>=2&&A0[0].charCodeAt($0-2)===v0;if(!H0){for(var h0=!1,D0=0,u=0;u<A0.index;u++)N.charCodeAt(u)===Z0&&D0++;if(h0=D0%2===1,!h0){let L=A0[1];p9(N,"</"+L,0)===-1&&(N=N.replace(/<[A-Z][A-Za-z0-9]*(?:\s[^>]*)?>([^<]*)$/,"$1"))}}}N!==s&&($=$.slice(0,Z)+N,J=Z+N.length)}let r=[];var M0=[];let n=Z;var I0=X.disableAutoLink||X.disableBareUrls||V.inAnchor?-1:$.indexOf("@",Z);for(I0>=J&&(I0=-1);Z<J;){let N=$.charCodeAt(Z),s=null;if(N===Z0){if(s=rZ($,Z,J),!s){var _0=S9($,Z,J,Z0);Z+=_0-1}}else if(N===j0||N===z0){var Y0=nZ($,Z,J);if(Y0){if(Y0.canOpen||Y0.canClose){Z>n&&r.push(n9($.slice(n,Z)));var P0=$.slice(Z,Z+Y0.len),J0=n9(P0);M0.push({idx:r.length,ch:N,len:Y0.len,canOpen:Y0.canOpen,canClose:Y0.canClose,active:!0}),r.push(J0),Z+=Y0.len,n=Z;continue}Z+=Y0.len-1}}else if(N===b0)s=iZ($,Z,J,V,X);else if(N===l0)s=aZ($,Z,J,V,X);else if(N===O0)Z+1<J&&$.charCodeAt(Z+1)===O9&&(s=tZ($,Z,J,V)),s||(s=x6($,Z,J,V,X));else if(N===f0&&Z+1<J&&$.charCodeAt(Z+1)===O0)s=x6($,Z,J,V,X);else if(N===t)s=s6($,Z,J),!s&&!X.disableParsingRawHTML&&!X.ignoreHTMLBlocks&&(s=ZJ($,Z,J,V,X));else if((N===l9||N===_9||N===N9)&&!V.inAnchor&&!X.disableAutoLink&&(Z===0||$.charCodeAt(Z-1)!==t)){var W0=Z+1<J?$.charCodeAt(Z+1):0;(N===l9&&W0===o9||N===N9&&W0===o9||N===_9&&W0===_9)&&(s=eZ($,Z,J,X))}if(!s&&I0>=0&&I0-Z<=64&&!V.inAnchor&&!X.disableAutoLink&&!X.disableBareUrls&&(N>=p&&N<=l||N>=Q0&&N<=q0||N>=i&&N<=a)&&(s=$J($,Z,J,X),!s&&Z>=I0&&(I0=$.indexOf("@",Z+1),I0>=J&&(I0=-1))),N===N$){Z>n&&r.push(n9($.slice(n,Z))),r.push({type:A.breakLine}),Z++,n=Z;continue}if(s)Z>n&&r.push(n9($.slice(n,Z))),r.push(s.node),Z=s.end,n=Z;else{if(N===y0&&Z+1<J){let B0=$.charCodeAt(Z+1);if(s$(B0)&i9){Z>n&&r.push(n9($.slice(n,Z))),r.push(n9($[Z+1])),Z+=2,n=Z;continue}}if(Z++,I0<0||I0-Z>64)for(;Z<J&&!(I0>=0&&I0-Z<=64);){var m=$.charCodeAt(Z);if(m<Z$&&!C6[m])Z++;else break}}}if(J>n){let N=$.slice(n,J);N&&r.push(n9(N))}return M0.length>0&&sZ(r,M0,Q,X),Q.f=Y,Q$--,r}var QJ=500;function k9($,Z,J){var Q=Z.i||0;if(Q>QJ)return[{type:A.text,text:$}];Z.i=Q+1;let X=Z;if(J.optimizeForStreaming&&!Z.j){var Y=$.length;Y>0&&$.charCodeAt(Y-1)===T&&Y--;for(var V=Y;V>0&&$.charCodeAt(V-1)!==T;)V--;if(V>0&&$.charCodeAt(V)===L0){for(var G=!0,q=V;q<Y;q++){var U=$.charCodeAt(q);if(U!==_&&U!==w&&U!==d&&U!==g0&&U!==L0){G=!1;break}}if(G){for(var W=V-1;W>0&&$.charCodeAt(W-1)!==T;)W--;$.charCodeAt(W)===L0&&($=$.slice(0,W).trimEnd())}}var F=$.trim(),O=F.lastIndexOf(`
`),K=O===-1?F:F.slice(O+1);if(K.length>0&&K.charCodeAt(0)===L0){for(var B=!1,z=!1,H=1;H<K.length;H++){var D=K.charCodeAt(H);D===L0&&(B=!0),D===d&&(z=!0)}B&&z&&($=O===-1?"":$.slice(0,$.lastIndexOf(K)).trimEnd())}for(var M=-1,v=-1,f=-1,I=$.length-1;I>=0;I--)if($.charCodeAt(I)===t){var j=I+1<$.length?$.charCodeAt(I+1):0;if(j>=p&&j<=l||j>=Q0&&j<=q0){for(var S=I+2;S<$.length;){var k=$.charCodeAt(S);if(k>=p&&k<=l||k>=Q0&&k<=q0||k>=i&&k<=a)S++;else break}for(var R=S;R<$.length&&$.charCodeAt(R)!==c;)R++;if(R<$.length&&$.charCodeAt(R-1)!==v0){for(var P=!1,E=R+1;E<$.length;E++)if($.charCodeAt(E)===t){P=!0;break}P||(M=I,v=S,f=R+1)}}break}if(M>=0){for(var b=0,g=0;g<M;g++)$.charCodeAt(g)===Z0&&b++;if(b%2===0){var x=$.slice(M+1,v);p9($,"</"+x,0)===-1&&($=$.slice(0,M)+$.slice(f))}}for(var h=$.length;h>0&&$.charCodeAt(h-1)===T;)h--;if(h>0){for(var y=h;y>0&&$.charCodeAt(y-1)!==T;)y--;for(var X0=y,o=0;X0<h&&$.charCodeAt(X0)===_&&o<3;)X0++,o++;if(y>0&&X0<h&&gZ($,X0,h)){for(var C=y-1,F0=C;F0>0&&$.charCodeAt(F0-1)!==T;)F0--;X9($,F0,C)||($=$.slice(0,y).trimEnd())}}var $0=$.length;if($0>0){for(var H0=$.lastIndexOf(`
`),h0=H0===-1?0:H0+1,D0=$0,u=h0,r=0;u<D0&&$.charCodeAt(u)===_&&r<3;)u++,r++;if(u<D0){var M0=$.charCodeAt(u),n=!1;if(M0===j0||M0===d||M0===b9){var I0=u+1;if(I0>=D0||$.charCodeAt(I0)===_||$.charCodeAt(I0)===w){for(var _0=I0;_0<D0&&($.charCodeAt(_0)===_||$.charCodeAt(_0)===w);)_0++;_0>=D0&&(n=!0)}}else if(M0>=i&&M0<=a){for(var Y0=u;Y0<D0&&$.charCodeAt(Y0)>=i&&$.charCodeAt(Y0)<=a;)Y0++;if(Y0<D0&&($.charCodeAt(Y0)===J9||$.charCodeAt(Y0)===D9)){var P0=Y0+1;if(P0>=D0||$.charCodeAt(P0)===_||$.charCodeAt(P0)===w){for(var J0=P0;J0<D0&&($.charCodeAt(J0)===_||$.charCodeAt(J0)===w);)J0++;J0>=D0&&(n=!0)}}}n&&($=$.slice(0,h0).trimEnd())}}}if(Z.inline)return i0($,0,$.length,Z,J);let W0=[],m=0,N=$.length;if(m===0&&!J.disableFrontmatter&&$.startsWith("---")){let L=v6($);if(L&&L.hasValidYaml){if(J.preserveFrontmatter!==!1){let N0=$.slice(0,L.endPos).trimEnd();W0.push({type:A.frontmatter,text:N0})}m=L.endPos}}for(;m<N;){for(var s=$.indexOf(`
`,m),B0=s<0?N:s;m<N&&X9($,m,B0);)m=B0<N?B0+1:B0,m<N&&(s=$.indexOf(`
`,m),B0=s<0?N:s);if(m>=N)break;$.charCodeAt(m),R0($,m,B0);let L=null;if(c6=$,l6=m,o6=B0,$.charCodeAt(m)!==$$&&U0>=4&&!Z.inHTML)L=xZ($,m);else if($.charCodeAt(m)!==$$){let N0=m+G0,V0=$.charCodeAt(N0);V0===v9?L=r6($,m,Z,J):V0===c?L=CZ($,m,Z,J):V0===Z0||V0===b0?L=hZ($,m,Z):V0===d||V0===j0||V0===z0?(L=d9($,m),!L&&(L=E6($,m,Z,J))):V0===b9||V0>=i&&V0<=a?L=E6($,m,Z,J):V0===t?L=a6($,m,Z,J):V0===L0?L=f6($,m,Z,J):V0===O0&&(L=dZ($,m,Z))}if(!L){for(var p0=!1,E0=m;E0<B0;E0++)if($.charCodeAt(E0)===L0){p0=!0;break}p0&&(L=f6($,m,Z,J))}if(L||(L=lZ($,m,Z,J)),L)L.node.type!==A.refCollection&&W0.push(L.node),m=L.end;else{var A0=$.indexOf(`
`,m);m=A0<0?N:A0+1}}return Z.i=Q,W0}function t$($,Z){Q$=0,$.charCodeAt(0)===65279&&($=$.slice(1)),$=o$($);let J={inline:!1,inAnchor:!1,inHTML:!1,inList:!1,inBlockQuote:!1,refs:{}},Q={...Z,slugify:Z?.slugify?Y=>Z.slugify(Y,Q9):Q9,sanitizer:Z?.sanitizer||J$,tagfilter:Z?.tagfilter!==!1};J.j=p6($,J.refs,Q);let X=k9($,J,Q);return F$(J.refs)?[{type:A.refCollection,refs:J.refs},...X]:X}function RJ($,Z,J,Q){var X=L9($,Z);return X?{tagName:X.tag,tagLower:X.tag.toLowerCase(),attrs:X.rawAttrs,whitespaceBeforeAttrs:X.whitespaceBeforeAttrs,isSelfClosing:X.selfClosing,hasSpaceBeforeSlash:X.hasSpaceBeforeSlash,isClosing:X.isClosing,hasNewline:X.whitespaceBeforeAttrs.includes(`
`)||X.rawAttrs.includes(`
`),endPos:X.end}:null}function t6($,Z,J){Q$=0,$=o$($),!Z.refs&&(Z.refs={}),Z.j=p6($,Z.refs,J);let Q=k9($,Z,J);return F$(Z.refs)?[{type:A.refCollection,refs:Z.refs},...Q]:Q}var Y$=F$;function I9($){if(!$)return $;var Z=$.indexOf("&"),J=$.indexOf("<");J!==-1&&(Z===-1||J<Z)&&(Z=J);var Q=$.indexOf(">");Q!==-1&&(Z===-1||Q<Z)&&(Z=Q);var X=$.indexOf('"');if(X!==-1&&(Z===-1||X<Z)&&(Z=X),Z===-1)return $;for(var Y=$.slice(0,Z),V=Z,G=$.length;Z<G;){var q=$.charCodeAt(Z);q<=62&&(q===t9?(Z>V&&(Y+=$.slice(V,Z)),Y+="&amp;",V=Z+1):q===t?(Z>V&&(Y+=$.slice(V,Z)),Y+="&lt;",V=Z+1):q===c?(Z>V&&(Y+=$.slice(V,Z)),Y+="&gt;",V=Z+1):q===G9&&(Z>V&&(Y+=$.slice(V,Z)),Y+="&quot;",V=Z+1)),Z++}return V<G&&(Y+=$.slice(V)),Y}function e$($){for(var Z=!1,J=0,Q=$.length;J<Q;){var X=$.charCodeAt(J);if(X===t9||X===t||X===c||X===G9){Z=!0;break}J++}return Z?$.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/&(?!([a-zA-Z0-9]+|#[0-9]+|#x[0-9a-fA-F]+);)/g,"&amp;"):$}function j9($){var Z="";for(var J in $){var Q=$[J];if(Q!=null)if(Z+=" ",Q===!0)Z+=J;else if(Q==="")Z+=J+'=""';else if(J==="style"&&typeof Q=="object"&&Q!==null){var X="",Y=!0;for(var V in Q){var G=Q[V];if(G!=null){Y?Y=!1:X+="; ";for(var q="",U=0;U<V.length;U++){var W=V.charCodeAt(U);W>=p&&W<=l?q+="-"+String.fromCharCode(W+o0):q+=V[U]}X+=q+": "+G}}X&&(Z+='style="'+e$(X)+'"')}else typeof Q=="string"?Z+=J+'="'+e$(Q)+'"':typeof Q=="number"&&(Z+=J+'="'+Q+'"')}return Z}var j$={};function $6($,Z){return $.type===A.footnote||$.type===A.ref||$.type===A.frontmatter&&!Z}function e6($,Z){if(!Y$(Z))return $||j$;var J=$?{...$}:{};for(var Q in Z)J[Q]=Z[Q];return J}function B$($,Z,J,Q){if(!J.hasOverrides)return!Q||!Y$(Q)?"<"+$+">"+Z+"</"+$+">":"<"+$+j9(Q)+">"+Z+"</"+$+">";var X=C9($,J.overrides),Y=m9($,J.overrides);if(!Q||!Y$(Q))return"<"+X+j9(Y)+">"+Z+"</"+X+">";var V={...Y};for(var G in Q)V[G]=Q[G];return"<"+X+j9(V)+">"+Z+"</"+X+">"}function q9($,Z){var J="";if(Z.renderRule)for(var Q=0;Q<$.length;Q++)J+=Z6($[Q],{key:Q},Z);else for(var Q=0;Q<$.length;Q++){var X=$[Q];X.type===A.text?X.text&&(J+=I9(X.text)):J+=T$(X,Z)}return J}function Z6($,Z,J){return J.renderRule?J.renderRule(function(){return $.type===A.ref||$.type===A.refCollection||$6($,J.preserveFrontmatter)?"":T$($,J)},$,function(Q){return q9(Q,J)},Z):$.type===A.ref||$.type===A.refCollection||$6($,J.preserveFrontmatter)?"":T$($,J)}function T$($,Z){switch($.type){case A.blockQuote:{var J=$.children?q9($.children,Z):"";return $.alert?(J="<header>"+I9($.alert)+"</header>"+J,B$("blockquote",J,Z,{class:"markdown-alert-"+Z.slug($.alert.toLowerCase(),Q9)})):B$("blockquote",J,Z)}case A.breakLine:return`<br />
`;case A.breakThematic:return"<hr />";case A.frontmatter:return"<pre>"+I9($.text)+"</pre>";case A.codeBlock:{var Q=$.attrs||{};if($.lang){Q={...Q};var X=x9($.lang),Y=Q.class||Q.className||"";Q.class=Y?Y+" language-"+X:"language-"+X,delete Q.className}var V=j9(Q),G=$.text||"";return"<pre><code"+V+">"+I9(G)+"</code></pre>"}case A.codeInline:return"<code>"+I9($.text||"")+"</code>";case A.footnoteReference:{var q=Z.sanitize($.target||"","a","href")||"",U=I9($.text||"");return'<a href="'+I9(q)+'"><sup>'+U+"</sup></a>"}case A.gfmTask:return"<input"+($.completed?' checked=""':"")+' disabled="" type="checkbox">';case A.heading:{var W=$.level||1,F=$.id?.trim()?{id:$.id}:void 0;return B$("h"+W,$.children?q9($.children,Z):"",Z,F)}case A.htmlComment:{var O=$;return O.raw?O.text:O.g?"<!--"+$.text+">":"<!--"+$.text+"-->"}case A.htmlBlock:{var K=$,B=K.tag||"div",z=Z.hasOverrides?C9(B,Z.overrides):B,H=Z.hasOverrides?m9(B,Z.overrides):j$,D;if(K.e!==void 0){var M=K.e,v=M.length>0&&M.charCodeAt(0)>_;D=(v?" ":"")+M+(Y$(H)?" "+j9(H).trim():"")}else D=j9(e6(K.attrs,H));if(Z.tagfilter&&R$(z))return K.b?"&lt;/"+z+">":"&lt;"+z+D+">";if(K.a){if(K.c){var H0=Z.tagfilter?z$(K.a):K.a;if(K.b)return"</"+z+">"+H0;var f=z.toLowerCase(),I=m6(f);if(I){for(var j=K.a.length,S=0;S<j&&K.a.charCodeAt(S)===_;)S++;if(S<j&&K.a.charCodeAt(S)===t){var k=K.a.indexOf(">",S);if(k!==-1){var R=K.a.slice(S,k+1);if(R.charCodeAt(1)>=Q0&&R.charCodeAt(1)<=q0){for(var P=1,E=P;E<R.length&&R.charCodeAt(E)>=Q0&&R.charCodeAt(E)<=q0;)E++;var b=R.slice(P,E).toLowerCase();if(b===f){var g=K.a.slice(k+1);return R+(Z.tagfilter?z$(g):g)}}}}var x="</"+f+">",h=K.a.indexOf(x)!==-1;return h?"<"+z+D+">"+H0:"<"+z+D+">"+H0+"</"+z+">"}var y=K.a.trim();if(y.length>0&&y.charCodeAt(0)===t){var X0=y.charCodeAt(1);if(X0>=Q0&&X0<=q0||X0>=p&&X0<=l){for(var P=1,E=P;E<y.length;){var o=y.charCodeAt(E);if(o>=Q0&&o<=q0||o>=p&&o<=l||o>=i&&o<=a||o===d)E++;else break}var b=y.slice(P,E).toLowerCase();if(b===f)return H0}}if(K.k){var C=H0.indexOf("</"+f+">"),F0=C!==-1?H0.slice(0,C):H0;return"<"+z+D+">"+F0+"</"+z+">"}for(var $0=0;$0<H0.length&&H0.charCodeAt($0)===_;)$0++;return"<"+z+D+">"+($0>0?H0.slice($0):y?H0:"")}var H0=Z.tagfilter?z$(K.a):K.a;return"<"+z+D+">"+H0+"</"+z+">"}if(K.e&&K.e.indexOf(`
`)!==-1&&K.a){var h0=Z.tagfilter?z$(K.a):K.a;return"<"+z+D+">"+h0+"</"+z+">"}if(a9(z))return"<"+z+D+">";var J=K.children?q9(K.children,Z):"";if(K.b)return"</"+z+">"+J;if(!K.c)return"<"+z+D+">"+J+"</"+z+">";for(var D0=0;D0<J.length;D0++){var u=J.charCodeAt(D0);if(u!==_&&u!==w&&u!==T&&u!==13)return"<"+z+D+">"+J+"</"+z+">"}return"<"+z+D+">"+J}case A.htmlSelfClosing:{var r=$,M0=r.tag||"div",n=Z.hasOverrides?C9(M0,Z.overrides):M0;if(r.a)return Z.tagfilter&&R$(n)?r.a.replace(/^</,"&lt;"):r.a;if(r.b)return"</"+n+">";var I0=Z.hasOverrides?m9(M0,Z.overrides):j$,_0=e6(r.attrs,I0),Y0=j9(_0);return Z.tagfilter&&R$(n)?"&lt;"+n+Y0+" />":"<"+n+Y0+" />"}case A.image:{var P0=Z.hasOverrides?C9("img",Z.overrides):"img",J0=Z.hasOverrides?m9("img",Z.overrides):j$,W0=Z.sanitize($.target||"","img","src")||"",m={...J0,alt:$.alt||""};return $.title&&(m.title=$.title),"<"+P0+' src="'+I9(W0)+'"'+j9(m)+" />"}case A.link:{var N=Z.hasOverrides?C9("a",Z.overrides):"a",s=Z.hasOverrides?m9("a",Z.overrides):j$,B0=Y$(s)?{...s}:{};if($.target!=null){var p0=r$(x9($.target)),E0=Z.sanitize(p0,"a","href");E0!==null&&(B0.href=E0===p0?E0:r$(E0))}return $.title&&(B0.title=x9($.title)),"<"+N+j9(B0)+">"+($.children?q9($.children,Z):"")+"</"+N+">"}case A.table:{for(var A0=$,L=A0.align||[],N0="",V0=A0.header||[],T0=0;T0<V0.length;T0++){var d0=L[T0];N0+="<th"+(d0?' align="'+d0+'"':"")+">"+q9(V0[T0],Z)+"</th>"}for(var x0="",U9=A0.cells||[],n0=0;n0<U9.length;n0++){var K9=U9[n0]||[];x0+="<tr>";for(var W9=0;W9<K9.length;W9++){var d0=L[W9];x0+="<td"+(d0?' align="'+d0+'"':"")+">"+q9(K9[W9],Z)+"</td>"}x0+="</tr>"}if(Z.hasOverrides){var E9=C9("table",Z.overrides),M9=j9(m9("table",Z.overrides));return"<"+E9+M9+"><thead><tr>"+N0+"</tr></thead>"+(x0?"<tbody>"+x0+"</tbody>":"")+"</"+E9+">"}return"<table><thead><tr>"+N0+"</tr></thead>"+(x0?"<tbody>"+x0+"</tbody>":"")+"</table>"}case A.text:return I9($.text||"");case A.textFormatted:return B$($.tag||"strong",$.children?q9($.children,Z):"",Z);case A.orderedList:case A.unorderedList:{for(var s0="",t0=$.items||[],c0=0;c0<t0.length;c0++)s0+="<li>"+q9(t0[c0],Z)+"</li>";var F9=$.type===A.orderedList?"ol":"ul",w0=$.type===A.orderedList&&$.start!=null&&$.start!==1?{start:$.start}:void 0;return B$(F9,s0,Z,w0)}case A.paragraph:{if(Z.forceInline)return $.children?q9($.children,Z):"";var J=$.children?q9($.children,Z):"",e0=0;if(J.indexOf(`
`)!==-1){for(var $9="",S0=0,Y9=0,A9=!1,C0=0;(e0=J.indexOf(` 
`,Y9))!==-1;){for(var V$=Y9;V$<e0;V$++){var o=J.charCodeAt(V$);o===t?(A9=!0,C0=0):o===c?(A9=!1,C0=0):A9&&o===G9&&C0++}A9&&C0%2===1?Y9=e0+2:($9+=J.slice(S0,e0)+`
`,S0=e0+2,Y9=S0)}S0>0&&(S0<J.length&&($9+=J.slice(S0)),J=$9)}if(!Z.hasOverrides)return"<p>"+J+"</p>";var D=j9(m9("p",Z.overrides)),z=C9("p",Z.overrides);return"<"+z+D+">"+J+"</"+z+">"}default:return""}}function YJ($,Z={}){for(var J=Z.sanitizer||J$,Q=Z.slugify||Q9,X=Z.refs||{},Y=Z.overrides||{},V={},G=[],q=!1,U=0;U<$.length;U++){var W=$[U];if(W.type===A.refCollection&&!q){V=W.refs||{},q=!0;continue}$6(W,!!Z.preserveFrontmatter)||G.push(W)}for(var F in V)X[F]=V[F];var O={sanitize:J,slug:Q,refs:X,overrides:Y,hasOverrides:Y$(Y),preserveFrontmatter:!!Z.preserveFrontmatter,tagfilter:!!Z.tagfilter,forceInline:!!Z.forceInline,renderRule:Z.renderRule},K="";if(Array.isArray($))if(O.renderRule)for(var B=0;B<G.length;B++)K+=Z6(G[B],{key:B,refs:X},O);else for(var B=0;B<G.length;B++)K+=T$(G[B],O);else K=Z6($,{refs:X},O);var z="";for(var F in X)if(F.charCodeAt(0)===O9){z||(z="<footer>");for(var H=F.slice(1),D=t6(X[F].target,{inline:!0,refs:X},{overrides:Y,sanitizer:J,slugify:function(F0){return Q(F0,Q9)},tagfilter:Z.tagfilter!==!1}),M=[],v=0;v<D.length;v++)D[v].type!==A.refCollection&&M.push(D[v]);var f={sanitize:J,slug:Q,refs:{},overrides:Y,hasOverrides:O.hasOverrides,preserveFrontmatter:O.preserveFrontmatter,tagfilter:O.tagfilter,forceInline:!0,renderRule:O.renderRule},I=q9(M,f);z+='<div id="'+e$(Q(H,Q9))+'">'+I9(H)+": "+I+"</div>"}if(z&&(z+="</footer>"),Z.wrapper===null)return K+z;var j=G.length>1,S=Z.wrapper!=null,k=S&&typeof Z.wrapper=="string",R=Z.forceWrapper||Z.forceInline&&S||j&&S;if(!R)return K+z;var P=K;if((Z.forceInline||Z.forceWrapper&&k&&!Z.wrapperWasAutoSet)&&!j&&G.length===1&&G[0].type===A.paragraph){var E=G[0];if(E.children){var b={sanitize:J,slug:Q,refs:{},overrides:Y,hasOverrides:O.hasOverrides,preserveFrontmatter:O.preserveFrontmatter,tagfilter:O.tagfilter,forceInline:!0,renderRule:O.renderRule};P=q9(E.children,b)}}var g=typeof Z.wrapper=="string"?Z.wrapper:Z.forceInline?"span":"div",x="";if(Z.wrapperProps){var h={};for(var y in Z.wrapperProps){var X0=Z.wrapperProps[y];if(X0!=null){var o=J(String(X0),g,y);o!==null&&(h[y]=o)}}x=j9(h)}return"<"+g+x+">"+P+z+"</"+g+">"}function LJ($,Z){var J=Z?.forceInline||!1,Q={...Z,overrides:Z?.overrides,sanitizer:Z?.sanitizer,slugify:Z?.slugify?function(W){return Z.slugify(W,Q9)}:Q9,tagfilter:Z?.tagfilter!==!1},X=t$($,{...Q,forceInline:J}),Y={...Z,forceInline:J},V=!1;if(Z?.wrapper===void 0){for(var G=0,q=0;q<X.length;q++){var U=X[q];U.type!==A.refCollection&&U.type!==A.footnote&&U.type!==A.ref&&(U.type!==A.frontmatter||!Z?.preserveFrontmatter)&&G++}G>1||Z?.forceWrapper?(Y.wrapper="div",V=!0):J&&G>0&&(Y.wrapper="span",V=!0)}return Y.wrapperWasAutoSet=V,YJ(X,Y)}export{Q9 as slugify,J$ as sanitizer,t$ as parser,LJ as compiler,YJ as astToHTML,A as RuleType};
